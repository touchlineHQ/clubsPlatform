...
export const TABLE_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS "club_config" ("id" TEXT PRIMARY KEY NOT NULL, "slug" TEXT NOT NULL UNIQUE, "name" TEXT NOT NULL, "active" INTEGER NOT NULL DEFAULT 1, "primaryColor" TEXT, "secondaryColor" TEXT, "data" TEXT, "seeded" INTEGER NOT NULL DEFAULT 0, "published" INTEGER NOT NULL DEFAULT 1, "createdAt" INTEGER NOT NULL)`,
  ...
  `CREATE TABLE IF NOT EXISTS "player_import_run_part" ("runId" TEXT NOT NULL REFERENCES "player_import_run"("id") ON DELETE CASCADE, "partIndex" INTEGER NOT NULL, "rowCount" INTEGER NOT NULL, "playersCreated" INTEGER NOT NULL, "registrationsCreated" INTEGER NOT NULL, "registrationsUpdated" INTEGER NOT NULL, "usersCreated" INTEGER NOT NULL, "usersSkipped" INTEGER NOT NULL, "errorCount" INTEGER NOT NULL, "recordedAt" INTEGER NOT NULL, PRIMARY KEY ("runId", "partIndex"))`,
];
...
// the migration. primaryColor, secondaryColor and published are intentionally absent:
// they are added by migrations 0009, 0015 and 0021 respectively.
